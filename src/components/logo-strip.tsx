        ...
        <Reveal className="flex flex-col gap-6">
          ...
          <ul className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-6">
            {reservedMarks.map((mark) => (
              <li
                key={mark}
                className="flex min-h-16 items-center justify-center rounded-xl border border-dashed border-cream/12 px-3 text-[0.65rem] tracking-[0.16em] text-white/35 uppercase"
              >
                Por publicar
              </li>
            ))}
