          ...
          <div className="flex flex-col gap-8">
            <Reveal className="flex max-w-md flex-col gap-5">
              ...
              <p className="text-base leading-relaxed text-muted-foreground">
                Tinta com direção. Sites que convertem. Este pedido não cria um
                evento nem envia convite. Serve para ensaiar o fluxo: serviço,
                janela, contexto, confirmação.
              </p>
            </Reveal>
            <NextSteps variant="call" />
            <Reveal>
